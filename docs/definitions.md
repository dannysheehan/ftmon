...
| `self` | the daemon | `cpu_pct rss_bytes db_bytes db_allocated_bytes db_used_bytes db_freelist_bytes db_headroom_bytes cycle_s tick_overruns event_* ring_mem_bytes entities_persisted series_persisted ...` | — |
