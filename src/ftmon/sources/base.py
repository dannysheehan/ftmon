    ...
    "self": SourceDecl(
        ...
        metrics=(
            ...
            _m("promotion_rejections_total", "count", "counter",
               "Promotion admission refusals at the per-monitor runtime cap"),
            ...
            *(
            ...
            _m("ring_mem_bytes", "bytes", "gauge",
               "Charged ring point and container memory (CA-04)"),
            _m("source_activity_age_s", "s", "gauge", "Seconds since event reader produced data"),
            _m("notify_pending_total", "count", "gauge", "Deliveries owed, including held"),
            _m("notify_due_claimable", "count", "gauge",
               "Deliveries due now and not held by quiet hours (NO-10)"),
            _m("notify_quiet_held", "count", "gauge",
               "Pending deliveries deliberately held by quiet hours"),
            _m("notify_failed", "count", "gauge", "Deliveries in terminal failure"),
            _m("notify_oldest_claimable_due_age_s", "s", "gauge",
               "Age of the oldest claimable-due delivery; grows when nothing drains"),
            _m("notify_worker_alive", "bool", "gauge",
               "1 when the background dispatcher thread is alive (PM-12)"),
            _m("notify_store_errors", "count", "counter",
               "Dispatcher store faults recovered or fatal (PM-12)"),
