...
def _self_panel(metrics: dict, params: dict, catalog: dict | None) -> dict:
    ...
    return {
        ...
        "catalog": {
            ...
            "promotion_limit_per_monitor": dm16.get("promotion_limit_per_monitor"),
            "promotion_limited_monitors": dm16.get("promotion_limited_monitors"),
            "promotion_rejections_total": dm16.get("promotion_rejections_total"),
